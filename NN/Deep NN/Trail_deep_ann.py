...
classifier.add(Dense(units=64,activation='relu',kernel_initializer='glorot_uniform',input_dim=15))
classifier.add(Dropout(p=0.1))
classifier.add(Dense(units=32,activation='relu',kernel_initializer='glorot_uniform'))
classifier.add(Dropout(p=0.1))  
...
classifier.save_weights('Stroke_5.h5')
...
newDF.to_csv('submission2_5_1.csv', index=False)